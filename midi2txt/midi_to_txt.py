...
def write_output(times, beat_times, output_file, beats_file=None, write_beats=False, offset=0, input_file=None):
...
def main():
    ...
    times, beat_times = midi_to_txt(input_file, bpm_param, write_beats)
    print("Writing output ...")
    write_output(times, beat_times, output_file, beats_file=None, write_beats=write_beats,
                 offset=offset, input_file=input_file)
    print("Finished.")
